package com.emsi.sqlite.adapter;
...
public class EtudiantRecycleAdapter extends RecyclerView.Adapter<EtudiantRecycleAdapter.EtudiantViewHolder> {
    ...
    public EtudiantRecycleAdapter(Context context, List<Etudiant> etudiantList, OnEtudiantListener onEtudiantListener){
    ...
    public void onBindViewHolder(@NonNull EtudiantViewHolder holder, int position) {
        ...
        if (etudiant.getImagePath() != null && !etudiant.getImagePath().isEmpty()) {
            ...
            if (bitmap != null) {
                ...
                holder.imageEtudiant.setImageResource(R.drawable.ic_launcher_foreground);
            }
        } else {
            holder.imageEtudiant.setImageResource(R.drawable.ic_launcher_foreground);
        }
